...
### Highlights
- **Workforce Intelligence Hub**: Complete overhaul of the management portal with a high-fidelity "Workforce Health" monitor and precision tracking.
- **Intelligence Library**: Re-branded and modernized knowledge base for enterprise-grade asset management.
- **Premium Agent Wizard**: Re-architected conversational UI for sophisticated agent deployment.
- **High-Fidelity Informatics**: Standardized all telemetry to use tabular formatting and jargon-free terminology (e.g., "Chat Volume" instead of "Intell Load").
- **Design System Consistency**: Unified DashboardHeader and navigation hierarchy across all platform modules.
...
### Highlights
- **Wibl Marketing Platform**: Comprehensive landing site including Pricing, Features, Security, Docs, and Contact pages.
- **Security V2**: Implementation of Prompt Injection detection, PII redaction, and Output Validation for AI agents.
- **Rate Limiting**: New Token Bucket rate limiting for API and agent protection.
- **Wibl Manager**: Automated provisioning system for multi-channel agent deployment.
- **Multi-Channel Expansion**: Added native setup flows for Telegram and Discord agents.

### Changes
- UI: Added `coral` brand variant to Badge component.
- UX: Integrated seamless navigation between marketing and portal dashboards.
- Docs: Built an internal documentation system with search and code snippets.
- Security: Added security audit logging for all agent interactions.
